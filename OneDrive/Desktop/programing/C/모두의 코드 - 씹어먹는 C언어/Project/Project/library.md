...
int asking_input(int* user_input, char* user_search);
...
int main_lib() {
    ...
    while (1) {
        ...
        if (user_choice == 1) {
            /* 책을 새로 추가하는 함수 호출 */
            add_book(ptr->book_name, ptr->auth_name, ptr->publ_name, ptr->borrowed, &num_total_book);
        }
        else if (user_choice == 2) {
            /* 책을 검색하는 함수 호출 */
            search_book(ptr->book_name, ptr->auth_name, ptr->publ_name, num_total_book, ptr->borrowed);
        }
        else if (user_choice == 3) {
            /* 책을 빌리는 함수 호출 */
            borrow_book(ptr->borrowed);
        }
        else if (user_choice == 4) {
            /* 책을 반납하는 함수 호출 */
            return_book(ptr->borrowed);
        }
...
int search_book(char(*book_name)[30], char(*auth_name)[30],
    ...
    asking_input(&user_input, user_search);
