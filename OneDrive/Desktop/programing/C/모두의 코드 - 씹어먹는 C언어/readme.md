...
* 이 부분의 크기는 반드시 컴파일 때에 100% 추호의 의심의 여지도 없이 정해져야 합니다.
* 모리의 힙 부분은 사용자가 자유롭게 할당하거나 해제할 수 있습니다. 따라서 우리의 malloc 함수는 이 힙에 위치하고 있다.
...
* '2 차원 배열 처럼 생긴' 포인터 배열은 2 차원 배열과는 달리 함수의 인자로 손쉽게 넘길 수 있다.
	...
	- main 함수의 인자로 전달되는 argv 역시 이와 같은 성격을 띕니다.
